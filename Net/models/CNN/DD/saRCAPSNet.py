# -*- coding: utf-8 -*-
"""
Created on Tue May  7 12:07:17 2019
...
class ReconstructionNet(nn.Module):
    def __init__(self, n_dim=16, n_classes=2):
...
if __name__ == '__main__':
    ...
    test_loader = torch.utils.data.DataLoader(
            datasets.MNIST('../data', train=False, transform=transforms.Compose(
                    [transforms.ToTensor()])),batch_size=args.test_batch_size, shuffle=False, **kwargs)
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        torch.save(model.state_dict(),'{:03d}_model_dict_{}routing_reconstruction{}.pth'.format(
                epoch, args.routing_iterations,args.with_reconstruction))